        ...
        <div className="card space-y-6 animate-fade-in-up">
            <div className="text-center border-b border-slate-700/50 pb-6">
                ...
                <div className="mt-6 flex flex-col items-center">
                    <span className="text-slate-500 uppercase tracking-widest text-sm font-semibold">Total Score</span>
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4">
                    {data.breakdown.map((item, idx) => (
                        <div key={idx} className="bg-slate-900/50 rounded-lg p-4 flex justify-between items-center border border-slate-800 hover:border-slate-700 transition-colors">
                            <div>
            ...
            <div className="pt-4">
                <button onClick={onReset} className="w-full py-3 rounded-lg border border-slate-600 text-slate-300 hover:bg-slate-800 transition-colors">
                    Calculate Another
                </button>
            </div>
        </div>
